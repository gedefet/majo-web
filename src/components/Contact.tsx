      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="font-sans text-base text-ink/60 leading-loose max-w-sm">
            ...
            <div className="flex flex-col gap-3 mt-2">
              ...
              >
                ...
                <span className="font-sans text-base text-ink tracking-wide">WhatsApp: +54 9 11 4099-6884</span>
              ...
              >
                ...
                <span className="font-sans text-base text-ink tracking-wide">@dramajotoledo</span>
                <svg className="w-4 h-4 text-ink/30 ml-auto group-hover:text-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5l7 7-7 7" />
                </svg>
              </a>
          ...
          <div className="bg-blush p-10 lg:p-12 flex flex-col gap-6 self-start">
            <div>
              <p className="font-sans text-sm tracking-widest uppercase text-gold mb-2">Primera consulta</p>
